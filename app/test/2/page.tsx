          ...
          <div className="space-y-6">
            ...
            <div className="mt-12">
              ...
              <div className="space-y-4">
                <p className="text-lg font-semibold">글로벌 매너와 역량을 보유한 청년 인재 양성</p>
                <p className="text-sm md:text-base">불평등한 기회에 순응하지 않고 다양한 기회들을 창출하여 돈이 없어서 인맥이 없어서 마땅히 누려야할 청소년, 청년 시기의 다양 경험들을 하게 해 줌으로서 세상 어디에서도 빛을 낼 수 있는 자기 주도적 인격체로 성장시키고자 합니다.</p>
                <p className="text-sm md:text-base">동남아시아 소민족 청소년, 여성과 소외계층과 비인기 스포츠 종목 선수들에게 다양한 기회를 통한 경험이 사회에 소중한 존재로 성장하여 세계 어느 곳에서도 다양성을 존중하며 배려와 매너를 겸비한 글로벌 구성원을 양성하는 그 목적이 있습니다.</p>
              </div>
            </div>
