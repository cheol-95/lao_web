		...
		<footer className="bg-[#404042] text-white mt-20">
			<div className="container mx-auto px-4 py-8">
				<div className="grid grid-cols-1 md:grid-cols-4 gap-6">
					...
					{/* Partner Links */}
					<div className="space-y-4">
						<h3 className="text-lg font-semibold">지원기관</h3>
						<div className="flex space-x-4">
							<a href="https://www.acrc.go.kr/" target="_blank" rel="noopener noreferrer">
								<Image
									// src="/acrc.png"
									src="/acrc_temp.jpg"
									alt="ACRC Logo"
							...
							<a href="https://www.nts.go.kr/nts/main.do" target="_blank" rel="noopener noreferrer">
								<Image
									// src="/nts.png"
									src="/nts_temp.jpg"
									alt="NTS Logo"
